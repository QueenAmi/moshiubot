        ...
        if message.from_user.id not in the_cegers:
            button = kb(
                [
                    ...
                    [("🔄 Restart Userbot"), ("🔄 Reset Costum Text")],
                    ["🆘 Dukungan"],
                ],
...
def Ads():
    ...
    if txt:
        ...
        msg = "Masih kosong, jika ingin promosi ads hubungi @MOSHI404"
    return msg
...
<b><u>[{nama_bot}](https://t.me/{bot.me.username})</u> adalah sebuah Bot multi client dengan multi bahasa . Dan memudahkan lo untuk membuat userbot.</b></blockquote>
<b>Ads: {Ads()}</b>
"""
        return msg
